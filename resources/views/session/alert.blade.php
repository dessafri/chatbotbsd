@if (session()->has('success'))
    <div class="position-absolute top-0 end-0 p-3" style="z-index: 1050;" height="24">
        <div class="alert alert-success d-flex align-items-center" role="alert" id="success-alert">
            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:">
                <use xlink:href="#check-circle-fill" />
            </svg>
            {{-- <i class="fa-solid fa-circle-info me-2" width="24" height="24"></i> --}}
            <div>
                <span class="text-white ms-1">{{ session('success') }}</span>
            </div>
        </div>
    </div>
    <script>
...
@if (session()->has('error'))
    <div class="position-absolute top-0 end-0 p-3" style="z-index: 1050; width: 300px;">
...
<!-- Inside your layout file (app.blade.php) -->
