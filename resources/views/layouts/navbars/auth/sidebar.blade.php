<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Dashboard Chatbot BSD</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('penagihan') ? 'active' : '' }}" href="{{ url('penagihan') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Data Penagihan</span>
                </a>
            </li>
                ...
                <a class="nav-link {{ Request::is('cabang') ? 'active' : '' }}" href="{{ url('cabang') }}">
                    <div
                        ...
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('cabang') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            {{-- <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('faktur') ? 'active' : '' }}" href="{{ url('faktur') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-solid fa-image ps-2 pe-2 text-center text-dark {{ Request::is('faktur') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1"> Input Bukti Faktur</span>
                </a>
            </li> --}}
            <li class="nav-item mt-2">
