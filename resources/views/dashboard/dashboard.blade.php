            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Penagihan</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ formatRupiah($totalPenagihan) }}
                                </h5>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Penagihan Terkirim</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $penagihanDeliver }}
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Penagihan Belum Terkirim</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $penagihanNotDeliver }}
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Invoice Penagihan</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $penagihanCount }}
                                </h5>
                            </div>
